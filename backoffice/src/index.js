...
import ContentUsersPublic from './components/ContentUsersPublic';
import ContentServicesList from './components/ContentServicesList';
import ContentIdentityProvider from './components/ContentIdentityProvider';
					...
					<Router> 
						<div>
							...
							<div className="app-content">
								...
								<Route path='/publicusers' component={ContentUsersPublic} />
								<Route path='/services' component={ContentServicesList} />
								<Route path='/infoidp' component={ContentIdentityProvider} />
							</div>
							<Footer />
							<Modal />
						</div>
